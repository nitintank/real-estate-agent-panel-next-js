...
//             formData.append('10nc_document_contract', file);
//         });
//         imagePaths.forEach((file) => {
//             formData.append('owners_document', file);
//         });
//         propertyDocumentPaths.forEach((file) => {
//             formData.append('payment_cheques', file);
//         });

//         try {
//             const response = await fetch('https://a.khelogame.xyz/create-agent-transaction', {
//                 method: 'POST',
//                 headers: {
...
//                             multiple
//                         />
//                         <label htmlFor="">{`Payment Cheques`}</label>
//                         <input
//                             type="file"
